...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cart__ = __webpack_require__(517);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angularfire2_database__ = __webpack_require__(133);
...
var CartPage = /** @class */ (function () {
    function CartPage(navCtrl, navParams, carting, fdb, loadingCtrl, alertCtrl) {
        var _this = this;
        ...
        this.arrData = [];
        this.cartRef = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref("total/");
        this.fdb.list("/total/").valueChanges().subscribe(function (_data) {
            _this.arrData = _data;
        });
        this.CartList$ = this.carting.getCartList().snapshotChanges().map(function (Change) {
    ...
    CartPage.prototype.addDetailItem = function (detail) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        var a = d.toString();
                        _this.CartList$.subscribe(function (_data) {
                            _this.cartData = _data;
                            _this.detail.DETAIL_ID = 'D_' + Math.floor(Date.now() / 100);
                            _this.detail.DETAIL_ORDER = _this.cartData;
                            _this.detail.DETAIL_TOTAL = _this.arrData;
                            _this.detail.BUYER_NAME = 'วรายุทธ เทกระโทก';
                            _this.detail.DETAIL_ADDRESS = "25/1-2 ซอย 15 ";
                            _this.detail.DETAIL_DATE = a;
                            _this.detail.DETAIL_STATUS = 'กำลังดำเนินการ';
                            setTimeout(function () {
                                _this.carting.addDetailItem(detail);
                            }, 2000);
                            /*
                        ...
                        _this.carting.removeCartItem();
                        var cartRef0000 = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref("total/");
                        cartRef0000.remove();
                        _this.navCtrl.setRoot('OrderListPage');
                    }
                }
            ]
        });
    ...
    CartPage.prototype.ionViewDidLoad = function () {
        var cartR = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database().ref("total/");
        cartR.remove();
        console.log('ionViewDidLoad FoodOrderPage');
        var total = 0;
        var cartRef11111 = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database()
            .ref("cart-list/");
        cartRef11111.orderByChild("CART_PRICE")
            ...
            total += add;
            var cartRe = __WEBPACK_IMPORTED_MODULE_4_firebase___default.a.database()
                .ref("total/");
            var totjk = {
                TOTAL_TOTAL: total
            };
    ...
    CartPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["m" /* Component */])({
            selector: 'page-cart',template:/*ion-inline-start:"G:\ChunWarayut\LungNuad\src\pages\cart\cart.html"*/'\n\n<ion-header>\n\n\n\n  <ion-navbar  color="boa">\n\n\n\n    \n\n      <button ion-button menuToggle>\n\n          <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n    \n\n\n\n    <!-- \n\n      <ion-title  *ngFor="let item of arrData"> รวม &nbsp;&nbsp; {{item}} &nbsp;&nbsp; บาท  </ion-title>\n\n  -->\n\n\n\n  </ion-navbar>\n\n\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n\n\n  <!-- <div>{{ CartList$ | async }}</div> -->\n\n  <button ion-button block (click)="GoBack()">สั่งอาหารเพิ่ม</button>\n\n  <button ion-button block color="energy" (click)=" addDetailItem(detail)">ยืนยันคำสั่งซื้อ</button>\n\n\n\n\n\n\n\n     \n\n\n\n<ion-grid>\n\n    <ion-row>\n\n      <ion-col *ngFor="let cart of CartList$ | async" > \n\n\n\n      <ion-list> \n\n          \n\n        <ion-item>\n\n        \n\n        <ion-label fixed> \n\n          ชื่ออาหาร : \n\n        </ion-label>\n\n\n\n        <ion-label id="NAME"> \n\n        {{cart.CART_NAME }}\n\n        </ion-label>\n\n\n\n        </ion-item>\n\n\n\n        <ion-item>\n\n\n\n        <ion-label fixed>           \n\n          จำนวน :       \n\n        </ion-label>  \n\n\n\n        <ion-label id="AMOUT">           \n\n          {{cart.CART_AMOUT}}   &nbsp;&nbsp;&nbsp;&nbsp;รายการ\n\n        </ion-label>  \n\n\n\n        </ion-item>\n\n\n\n        <ion-item>\n\n\n\n        <ion-label fixed> \n\n          ราคา : \n\n        </ion-label>\n\n\n\n        <ion-label id="PRICE"> \n\n        {{cart.CART_PRICE}}   &nbsp;&nbsp;&nbsp;&nbsp;บาท  \n\n          </ion-label>\n\n  \n\n        </ion-item>\n\n\n\n      </ion-list>\n\n\n\n    </ion-col>\n\n   \n\n\n\n  </ion-row>\n\n</ion-grid>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"G:\ChunWarayut\LungNuad\src\pages\cart\cart.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1__providers_service_service__["a" /* ServiceProvider */],
